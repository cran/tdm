...
### theta1(cl_F)<-(0.99+bw/70*0.833)*(1-Gender*0.203);theta2<-4.43;theta3<-0.113
initsList = list(cl_F=(0.99+f/70*0.833)*(1-g*0.203),v_F=4.43,ka=0.113)  # initialize prior here; not working if use 'bw' instead of 'd' here.  --YJ
...
model.file <- system.file("PK", "EnfSMmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
