...
initsList = list(cl_F=0.105+0.151*f+0.000248*d/b*24+0.0968*e/20+0.0803*g,
...
model.file <- system.file("PK", "ValSSmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
