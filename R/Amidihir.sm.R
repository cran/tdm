...
initsList = list(cl_F=(0.037*IBW-0.006*g)*(1.284^h)*(0.751^j),v_F=0.42*IBW)  # initialize prior here; not working if use 'bw' instead of 'd' here.  --YJ
...
model.file <- system.file("PK", "AmidihirSMmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
