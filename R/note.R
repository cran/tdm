...
note_for_infusionR_c_to_d <- function(){
     ...
     cat("                                                  \n")
     cat("  --output data--                                 \n")
     cat("  Ro = intravenous infusion rate (mg/hr)  \n")
     cat("--------------------------------------------------\n\n")
         }
...
note_for_infusionR_d_to_c <- function(){
     cat("-------------------------------------------------\n")                                     
     cat("  --input data--                                 \n")
     cat("  Ro = constant intravenous infusion rate (mg/hr) \n")
     cat("                                                 \n")
     cat("  --output data--                                \n")
     cat("  Css_trough = calculated trough conc (mg/L)      \n")
     cat("-------------------------------------------------\n\n")
...
note_for_c_to_d_meq <- function(){ 
     ...
     cat("  tau = desired dosing interval (hr)        \n\n")
     cat(" Lithium usual therapeutic range: 0.6-1.3 mEq/L\n\n")     
     cat("  --output data--                             \n")
     cat("  Dose = calculated dose (mg)                 \n")
     cat("--------------------------------------------\n\n")
 }
...
note_for_c_to_d_eno <- function(){ 
     cat("-----------------------------------------------------------------\n")
     cat("  --input data--                                                 \n")
     cat("  Amax = desired anti-Xa maximal activity at steady state (IU/mL) \n")
     cat("  tau = desired dosing interval (hr)                             \n")
     cat("                                                                 \n")
     cat("  --output data--                                                \n")
     cat("  Dose = calculated dose (mg, 1 mg = 100 IU)                     \n")
     cat("-----------------------------------------------------------------\n\n")
 }
...
note_for_d_to_c_eno <- function(){ 
     cat("--------------------------------------------------------------------\n")
     cat("  --input data--                                                    \n")
     cat("  D = desired dose (mg, 1 mg = 100IU)                               \n")
     cat("  tau = desired dosing interval (hr)                                \n")
     cat("                                                                    \n")
     cat("  --output data--                                                   \n")
...
note_for_CBZss_input <- function(){
     ...
     cat("    E = age older than 65yr(Y=1;N=0)                         \n")
     cat("    D = dose for each dosing interval(mg) (200-600 mg q12h)  \n")
     cat("    tau = dosing interval(hr)(q12h or q24h)                  \n")
...
note_for_Lit_input <- function(){
     ...
     cat("    D = dose for each dosing interval(mg)            \n")
     cat("    tau = dosing interval(hr)                        \n")
     cat("    Css = measured steady-state conc.(mEq/L)           \n")  
     cat("-----------------------------------------------------\n")
}
...
note_for_Eno_input <- function(){
     ...
     cat("    TBW = body weight(kg)                                     \n")   
     cat("    Scr = serum creatinine conc.(mg/dL)                       \n")
     cat("    D = dose (mg) for each dosing interval; (1mg = 100 IU)    \n")
     cat("    tau = dosing interval(hr); (usually 12 hr)                \n")
     cat("    Amax = anti-Xa maximal activity at steady state (IU/mL)   \n")
     cat("--------------------------------------------------------------\n") 
}
...
note_for_Eno_output <- function(){
     ...
     cat("  cl_F = estimated clearance/bioavailability (L/hr)                        \n")
     cat("  v_F = estimated volume of distribution/bioavailability (L)               \n")
     cat("  Amaxss_pr = calculated anti-Xa maximal activity at steady state (IU/mL)  \n")
     cat("--------------------------------------------------------------------------\n") 
}
...
note_for_Valss_output <- function(ts){
     cat("--------------------------------------------------------------\n")
     cat("    --Valpraote output data information--                     \n")
     cat("    cl_F = estimated clearance (L/hr)                         \n")
     cat("     v_F = estimated volume of distribution (L)               \n")
     cat("      ka = absorption rate constant (/hr)                     \n")
     cat("    Cmss_pr = calculated steady-state conc.(mg/L) at time =",ts,"\n")
     cat("    Ctss_pr = calculated steady-state trough conc.(mg/L)      \n")
     cat("--------------------------------------------------------------\n")
}
...
note_for_Valsm_conc_input <- function(){
     cat("--------------------------------------------------\n")
     cat("    --Valpraote input data information--          \n")
     cat("    c = measured steady-state conc.(mg/L) at 'ts' \n")
     cat("    ts = sampling time (hr)                       \n") 
     cat("--------------------------------------------------\n")
}
...
note_for_Ritss_input <- function(){
     ...
     cat("    LPV = combine with Lopinavir? (Y=1;N=0)      \n")
     cat("    D = dose for each dosing interval(mg)        \n")
     cat("    tau = dosing interval(hr)                    \n")
     cat("    ts = sampling time(hr)                       \n")
     cat("    c = measured steady-stat conc.(mcg/L)        \n")    
     cat("-------------------------------------------------\n")
}
...
note_for_Cycss_output <- function(){
     ...
     cat("   cl = estimated clearance (L/hr)                           \n")
     cat("   Cmss_pr = calculated steady-state (SS) conc.(mcg/L) at ts \n")
     cat("   C(2)_pr = calculated SS conc.(mcg/L) at time = 2 hr       \n")
     cat("   Ctss_pr = calculated SS trough conc.(mcg/L)               \n")
     cat("-------------------------------------------------------------\n")
}
...
note_for_Tacss_input <- function(){
     ...
     cat("    Dil = combine with Diltiazem? (Yes=1, No=0)       \n")
     cat("    Flu = combine with Fluconazole? (Yes=1, No=0)     \n")
     cat("    D = dose for each dosing interval(mg)             \n")
     cat("    tau = dosing interval(hr)                         \n")
     cat("    ts = sampling time(hr)                            \n")  
...
note_for_Tacss_output <- function(){
     ...
     cat("    cl_F = estimated clearance/bioavailability (L/hr)              \n")
     ### cat("    v_F = estimated volume of distribution/bioavailability (L)     \n")   ### no 'v_F' with tacrolimus. -YJ
     cat("    Cmss_pr = calculated steady-state conc.(mcg/mL) at time of ts  \n")
...
note_for_Imass_input <- function(){
     ...
     cat("    BW = body weight(kg)                              \n")
     cat("    OCC = dichotomous covariate for time (two occasions)\n")
     cat("        = 0 for day 1 and 1 for day 29                \n")
     ...
     cat("ref.:Schmidli, H., B. Peng, et al. (2005). Population  \n")
     cat("    pharmacokinetics of imatinib mesylate in patients  \n")
     cat("    with chronic-phase chronic myeloid leukaemia:      \n")
     cat("    results of a phase III study. Br J Clin Pharmacol  \n")
     cat("    60(1): 35-44.                                      \n")
     cat("------------------------------------------------------\n")
}
...
note_for_Theirss_output <- function(){
     cat("    cl_F = estimated clearance/bioavailability (L/hr)             \n")
     cat("    v_F = estimated volume of distribution/bioavailability (L)    \n")
     cat("    Cmss_obs = the steady-state measured conc.(mg/L)              \n")
     cat("    Cmss_pr = calculated steady-state measured conc.(mg/L)        \n")
     cat("    Cpss_pr = calculated steady-state peak conc.(mg/L)            \n")
     cat("    Ctss_pr = calculated steady-state trough conc.(mg/L)          \n")
}
...
note_for_Theinfusionss_output <- function(){
     cat("   cl = estimated clearance (L/hr)                         \n")
     cat("   Cm_obs = obs. theo plasma conc.(mg/L)                   \n")
     cat("   Cm_pr  = calculated theo plasma conc.(mg/L)             \n")
     cat("   Css_pr = calculated theo steady-state conc.(mg/L)       \n")
}
