...
### theta1(cl_F)<-theta1<-10.5*pow(2.72, LPV);theta2<-96.6,theta3<-0.871
initsList = list(cl_F=10.5*(2.72^e),v_F= 96.6,ka=0.871)  # initialize prior here; not working if use 'bw' instead of 'd' here.  --YJ
...
model.file <- system.file("PK", "RitSSmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
