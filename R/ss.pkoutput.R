# output file of Digoxin including individual information and predict PK parameters obtained from single concentration
Digss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Carbamazepine including individual information and predict PK parameters obtained from single concentration
Carss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Aminoglycosid including individual information and predict PK parameters obtained from single concentration
Amiss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Pediatric Digoxin including individual information and predict PK parameters obtained from single concentration
PedDigss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Lithium carbonate including individual information and predict PK parameters obtained from single concentration
Litss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Lithium citrat including individual information and predict PK parameters obtained from single concentration
Litcitss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Phenytoin including individual information and predict PK parameters obtained from single concentration
Phess.pkoutput<-function(B,F){
cat("\n")
...
# output file of children Valproate including individual information and predict PK parameters obtained from single concentration
ChiValss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Valproat including individual information and predict PK parameters obtained from single concentration
Valss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Vancomycin including individual information and predict PK parameters obtained from single concentration
Vanss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Enfuvirtide including individual information and predict PK parameters obtained from single concentration
Enfss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Indinavir including individual information and predict PK parameters obtained from single concentration
Indss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Ritonavir including individual information and predict PK parameters obtained from single concentration
Ritss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Cyclosporine including individual information and predict PK parameters obtained from single concentration
Cycss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Everolimus including individual information and predict PK parameters obtained from single concentration
Evess.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Tacrolimus including individual information and predict PK parameters obtained from single concentration
Tacss.pkoutput<-function(B,F,G){
cat("\n")
...
# output file of Enoxapar including individual information and predict PK parameters obtained from single concentration
Enoss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Imatinib mesylate including individual information and predict PK parameters obtained from single concentration
Imass.pkoutput<-function(B,F,H){
cat("\n")
...
# output file of Warfarin including individual information and predict PK parameters obtained from single concentration
Warss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Aminophylline anhydrous IR including individual information and predict PK parameters obtained from single concentration
Amianhirss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Aminophylline anhydrous CR including individual information and predict PK parameters obtained from single concentration
Amianhcrss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Aminophylline anhydrous iv infusion including individual information and predict PK parameters obtained from single concentration
Amianhinfusionss.pkoutput<-function(B,F,K){
cat("\n")
...
# output file of Aminophylline dihydrous IR including individual information and predict PK parameters obtained from single concentration
Amidihirss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Aminophylline dihydrous CR including individual information and predict PK parameters obtained from single concentration
Amidihcrss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Aminophylline dihydrous iv infusion including individual information and predict PK parameters obtained from single concentration
Amidihinfusionss.pkoutput<-function(B,F,K){
cat("\n")
...
# output file of Oxtriphylline IR including individual information and predict PK parameters obtained from single concentration
Oxtirss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Oxtriphylline C including individual information and predict PK parameters obtained from single concentration
Oxtcrss.pkoutput<-function(B,F){
cat("\n")
...
# output file of Theophylline IR including individual information and predict PK parameters obtained from single concentration
Theirss.pkoutput<-function(B,F,G,H){
cat("\n")
...
# output file of Theophylline CR including individual information and predict PK parameters obtained from single concentration
Thecrss.pkoutput<-function(B,F){
cat("\n")
