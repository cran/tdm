Amidihinfusion.sm<-function(a,b,c,g,h,i,j,k,L,m,n){
### library(BRugs)                                        # active BRugs
library(R2jags)
### oldwd<-getwd()
### setwd(system.file("PK",package="tdm"))                # set working directory
### modelCheck("AmidihinfusionSMmodel.txt")               # Load model
...
model.file <- system.file("PK", "AmidihinfusionSMmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
