...
initsList = list(cl_F=0.012*(f^0.715)*((e/f*24/d)^0.306)*(1+0.359*g),
                 ka=4., vd_F=0.24*f)                       # initialize prior here; not working if use 'bw' instead of 'd' here.  --YJ
...
model.file <- system.file("PK", "ChiValSMmodel.txt", package="tdm")   ### give the file location to find model file  -YJ
